 ...
 *
 * ./test-info-cache-integration /home/ondra/ localtest:///home/ondra
 */
...
test_setattribute ()
{
  ...
  i = g_file_query_info (f, "*", G_FILE_QUERY_INFO_NONE, NULL, &e);
  g_assert_no_error (e);
  g_object_unref (i);
...
test_move ()
{
  ...
  i = g_file_query_info (f2, "*", G_FILE_QUERY_INFO_NONE, NULL, &e);
  g_assert_no_error (e);
  g_file_info_get_modification_time (i, &r);
  g_assert_cmpint (r.tv_sec, !=, TEST_TIME);
  g_object_unref (i);
...
main (int argc, char *argv[])
{
  ...
  if (argc != 3)
  {
    g_printerr ("usage: test-info-cache-integration <local_test_dir_path> <remote_test_dir_uri>\n");
    return 1;
  }
  ...
  local_test_dir_path = g_build_filename (argv[1], "test-info-cache-local", NULL);
  remote_test_dir_uri = g_build_filename (argv[2], "test-info-cache-remote", NULL);
  ...
  g_test_add_func ("/info_cache/setattribute", test_setattribute);
  g_test_add_func ("/info_cache/delete", test_delete);
  g_test_add_func ("/info_cache/trash", test_trash);
  g_test_add_func ("/info_cache/pull", test_pull);
  g_test_add_func ("/info_cache/push", test_push);
  g_test_add_func ("/info_cache/setdisplayname", test_setdisplayname);
  g_test_add_func ("/info_cache/move", test_move);
  g_test_add_func ("/info_cache/copy", test_copy);
